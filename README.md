...
Automated Documentation Sync Bot: a GitHub Action plus LLM agent that turns a merged upstream PR into a draft docs PR. Mentored by Red Hat engineers on the krkn-chaos team, 54+ PRs merged upstream so far.
